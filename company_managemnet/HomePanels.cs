...
namespace CompanyManagement.Forms
{
    ...
    public class HomePanel : Panel
    {
        ...
        private void BuildUI()
        {
            ...
            try
            {
                int empCount  = new EmployeeBLL().GetAll().Count;
                int projCount = new ProjectBLL().GetAll().Count;
                int taskCount = new TaskBLL().GetAll().Count;
                int repCount  = new ReportBLL().GetAll().Count;
    ...
    public class EmployeeHomePanel : Panel
    {
        ...
        private void BuildUI()
        {
            ...
            try
            {
                List<TaskItemModel> tasks = new TaskBLL().GetByEmployee(emp.ID);
    ...
    public class ViewProjectsPanel : Panel
    {
        ...
        private void BuildUI()
        {
            ...
            try
            {
                List<ProjectModel> list = new ProjectBLL().GetAll();
    ...
    public class MyTasksPanel : Panel
    {
        ...
        private void BuildUI()
        {
            ...
            try
            {
                List<TaskItemModel> list = new TaskBLL().GetByEmployee(empID);
